...
public class PDActionURITest {
  ...
  public void testUTF8URI() {
    ...
    Assert.assertNull(actionURI.getURI());
    actionURI.setURI("http://çµ„åŒ¶æ›¿ç¶Ž.com/");
    Assert.assertEquals("http://経営承継.com/", actionURI.getURI());
  }
  ...
  public void testUTF16BEURI() throws IOException {
    ...
    Assert.assertEquals("http://www.nap.edu/catalog/11140.html", actionURI.getURI());
  }
  ...
  public void testUTF16LEURI() throws IOException {
    ...
    actionURI.getCOSObject().setItem(COSName.URI, utf16URI);
    Assert.assertEquals("http:", actionURI.getURI());
  }
  ...
  public void testUTF7URI() {
    ...
    Assert.assertEquals("http://pdfbox.apache.org/", actionURI.getURI());
  }
}
