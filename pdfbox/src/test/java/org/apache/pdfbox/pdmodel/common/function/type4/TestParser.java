...
public class TestParser extends TestCase {
  ...
  public void testParseFloat() throws Exception {
    TestCase.assertEquals(0, InstructionSequenceBuilder.parseReal("0"), 0.00001f);
    TestCase.assertEquals(1, InstructionSequenceBuilder.parseReal("1"), 0.00001f);
    TestCase.assertEquals(1, InstructionSequenceBuilder.parseReal("+1"), 0.00001f);
    TestCase.assertEquals(-1, InstructionSequenceBuilder.parseReal("-1"), 0.00001f);
    TestCase.assertEquals(3.14157, InstructionSequenceBuilder.parseReal("3.14157"), 0.00001f);
    TestCase.assertEquals(-1.2, InstructionSequenceBuilder.parseReal("-1.2"), 0.00001f);

    TestCase.assertEquals(1.0E-5, InstructionSequenceBuilder.parseReal("1.0E-5"), 0.00001f);
  }
