...
public class PDChoiceTest {
  ...
  public void createListBox() {
    ...
    Assert.assertEquals(choiceField.getFieldType(), choiceField.getCOSObject().getNameAsString(COSName.FT));
    Assert.assertEquals(choiceField.getFieldType(), "Ch");
    Assert.assertFalse(choiceField.isCombo());
  }
  ...
  public void createComboBox() {
    ...
    Assert.assertEquals(choiceField.getFieldType(), choiceField.getCOSObject().getNameAsString(COSName.FT));
    Assert.assertEquals(choiceField.getFieldType(), "Ch");
    Assert.assertTrue(choiceField.isCombo());
  }
  ...
  public void getOptionsFromStrings() {
    ...
    Assert.assertEquals(options, choiceField.getOptions());
  }
