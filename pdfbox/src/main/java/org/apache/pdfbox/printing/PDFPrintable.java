...
public final class PDFPrintable implements Printable {
  ...
  /**
   * Creates a new PDFPrintable with the given page scaling and with optional page
   * borders shown.
   *
   * @param document       the document to print
   * @param scaling        page scaling policy
  ...
  /**
   * Creates a new PDFPrintable with the given page scaling and with optional page
   * borders shown. The image will be rasterized at the given DPI before being
   * sent to the printer.
   *
   * @param document       the document to print
   * @param scaling        page scaling policy
  ...
  public int print(final Graphics graphics, final PageFormat pageFormat, final int pageIndex) throws PrinterException {
    ...
    try {
      ...
      if (dpi > 0) {
        ...
        image = new BufferedImage((int) (imageableWidth * dpiScale / scale), (int) (imageableHeight * dpiScale / scale),
  ...
  /**
   * This will find the CropBox with rotation applied, for this page by looking up
   * the hierarchy until it finds them.
   *
  ...
  /**
   * This will find the MediaBox with rotation applied, for this page by looking
   * up the hierarchy until it finds them.
   *
