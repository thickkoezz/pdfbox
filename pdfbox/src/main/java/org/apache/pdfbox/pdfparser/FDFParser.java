...
public class FDFParser extends COSParser {
   ...
   */
  public FDFParser(final String filename) throws IOException {
   ...
   * @throws IOException If something went wrong.
   */
  public FDFParser(final File file) throws IOException {
   ...
   * @throws IOException If something went wrong.
   */
  public FDFParser(final InputStream input) throws IOException {
  ...
  private void init() throws IOException {
    ...
    if (eofLookupRangeStr != null) {
      try {
        ...
        FDFParser.LOG.warn("System property " + COSParser.SYSPROP_EOFLOOKUPRANGE
  ...
  private void initialParse() throws IOException {
    ...
    final COSBase rootObject = parseTrailerValuesDynamically(trailer);
   ...
   *
   * @throws IOException If there is an error reading from the stream or corrupt
   *                     data is found.
   */
