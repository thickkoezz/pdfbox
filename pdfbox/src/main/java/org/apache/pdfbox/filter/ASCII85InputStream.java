  ...
  public int read() throws IOException {
    if (index >= n) {
      ...
      do {
        ...
        z = (byte) zz;
      } while (z == ASCII85InputStream.NEWLINE || z == ASCII85InputStream.RETURN || z == ASCII85InputStream.SPACE);

      if (z == ASCII85InputStream.TERMINATOR) {
        eof = true;
        ascii = b = null;
        n = 0;
        return -1;
      } else if (z == ASCII85InputStream.Z) {
        b[0] = b[1] = b[2] = b[3] = 0;
        n = 4;
      } else {
        ...
        for (k = 1; k < 5; ++k) {
          ...
          if (z == ASCII85InputStream.TERMINATOR) {
            ...
            ascii[k] = (byte) ASCII85InputStream.PADDING_U;
            break;
          }
        }
        n = k - 1;
        ...
        long t = 0;
        for (k = 0; k < 5; ++k) {
          z = (byte) (ascii[k] - ASCII85InputStream.OFFSET);
          if (z < 0 || z > 93) {
            n = 0;
            eof = true;
            ascii = null;
