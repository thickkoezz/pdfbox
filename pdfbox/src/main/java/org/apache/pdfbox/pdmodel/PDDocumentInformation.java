...
/**
 * This is the document metadata. Each getXXX method will return the entry if it
 * exists or null if it does not exist. If you pass in null for the setXXX
...
public class PDDocumentInformation implements COSObjectable {
  ...
  /**
   * This will get the title of the document. This will return null if no title
   * exists.
   *
  ...
  /**
   * This will get the author of the document. This will return null if no author
   * exists.
   *
  ...
  /**
   * This will get the subject of the document. This will return null if no
   * subject exists.
   *
  ...
  /**
   * This will get the keywords of the document. This will return null if no
   * keywords exists.
   *
  ...
  /**
   * This will get the creator of the document. This will return null if no
   * creator exists.
   *
  ...
  /**
   * This will get the producer of the document. This will return null if no
   * producer exists.
   *
  ...
  /**
   * This will get the creation date of the document. This will return null if no
   * creation date exists.
   *
  ...
  /**
   * This will get the modification date of the document. This will return null if
   * no modification date exists.
   *
  ...
  /**
   * This will get the trapped value for the document. This will return null if
   * one is not found.
   *
  ...
  /**
   * This will get the value of a custom metadata information field for the
  ...
  /**
   * This will set the trapped of the document. This will be 'True', 'False', or
   * 'Unknown'.
   *
