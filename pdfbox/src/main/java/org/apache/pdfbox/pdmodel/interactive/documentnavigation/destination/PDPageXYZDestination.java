...
/**
 * This represents a destination to a page at an x,y coordinate with a zoom
 * setting. The default x,y,z will be whatever is the current value in the
 * viewer application and are not required.
 *
...
public class PDPageXYZDestination extends PDPageDestination {
  ...
  public PDPageXYZDestination() {
    super();
    array.growToSize(5);
    array.setName(1, PDPageXYZDestination.TYPE);
  }
  ...
  /**
   * Get the left x coordinate. Return values of 0 or -1 imply that the current
  ...
  /**
   * Get the top y coordinate. Return values of 0 or -1 imply that the current
  ...
  /**
   * Get the zoom value. Return values of 0 or -1 imply that the current zoom will
   * be used.
   *
