...
public final class PDFontDescriptor implements COSObjectable {
  ...
  public boolean isFixedPitch() {
    return isFlagBitOn(PDFontDescriptor.FLAG_FIXED_PITCH);
  }
  ...
  public void setFixedPitch(final boolean flag) {
    setFlagBit(PDFontDescriptor.FLAG_FIXED_PITCH, flag);
  }
  ...
  public boolean isSerif() {
    return isFlagBitOn(PDFontDescriptor.FLAG_SERIF);
  }
  ...
  public void setSerif(final boolean flag) {
    setFlagBit(PDFontDescriptor.FLAG_SERIF, flag);
  }
  ...
  public boolean isSymbolic() {
    return isFlagBitOn(PDFontDescriptor.FLAG_SYMBOLIC);
  }
  ...
  public void setSymbolic(final boolean flag) {
    setFlagBit(PDFontDescriptor.FLAG_SYMBOLIC, flag);
  }
  ...
  public boolean isScript() {
    return isFlagBitOn(PDFontDescriptor.FLAG_SCRIPT);
  }
  ...
  public void setScript(final boolean flag) {
    setFlagBit(PDFontDescriptor.FLAG_SCRIPT, flag);
  }
  ...
  public boolean isNonSymbolic() {
    return isFlagBitOn(PDFontDescriptor.FLAG_NON_SYMBOLIC);
  }
  ...
  public void setNonSymbolic(final boolean flag) {
    setFlagBit(PDFontDescriptor.FLAG_NON_SYMBOLIC, flag);
  }
  ...
  public boolean isItalic() {
    return isFlagBitOn(PDFontDescriptor.FLAG_ITALIC);
  }
  ...
  public void setItalic(final boolean flag) {
    setFlagBit(PDFontDescriptor.FLAG_ITALIC, flag);
  }
  ...
  public boolean isAllCap() {
    return isFlagBitOn(PDFontDescriptor.FLAG_ALL_CAP);
  }
  ...
  public void setAllCap(final boolean flag) {
    setFlagBit(PDFontDescriptor.FLAG_ALL_CAP, flag);
  }
  ...
  public boolean isSmallCap() {
    return isFlagBitOn(PDFontDescriptor.FLAG_SMALL_CAP);
  }
  ...
  public void setSmallCap(final boolean flag) {
    setFlagBit(PDFontDescriptor.FLAG_SMALL_CAP, flag);
  }
  ...
  public boolean isForceBold() {
    return isFlagBitOn(PDFontDescriptor.FLAG_FORCE_BOLD);
  }
  ...
  public void setForceBold(final boolean flag) {
    setFlagBit(PDFontDescriptor.FLAG_FORCE_BOLD, flag);
  }
  ...
  /**
   * The weight of the font. According to the PDF spec "possible values are 100,
   * 200, 300, 400, 500, 600, 700, 800 or 900" Where a higher number is more
   * weight and appears to be more bold.
   *
  ...
  /**
   * A string representing the preferred font stretch. According to the PDF Spec:
  ...
  public PDRectangle getFontBoundingBox() {
    final COSArray rect = (COSArray) dic.getDictionaryObject(COSName.FONT_BBOX);
  ...
  public float getCapHeight() {
    if (Float.compare(capHeight, Float.NEGATIVE_INFINITY) == 0) {
      /*
       * We observed a negative value being returned with the Scheherazade font.
       * PDFBOX-429 was logged for this. We are not sure if returning the absolute
       * value is the correct fix, but it seems to work.
       */
  ...
  /**
   * This will get the missing width for the font from the /MissingWidth
   * dictionary entry.
   *
