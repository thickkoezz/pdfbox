...
public class PDAnnotationCaret extends PDAnnotationMarkup {
  ...
  public PDAnnotationCaret() {
    getCOSObject().setName(COSName.SUBTYPE, PDAnnotationCaret.SUB_TYPE);
  }

  /**
   * Creates a Caret annotation from a COSDictionary, expected to be a correct
   * object definition.
   *
   ...
   * defined by /Rect and boundaries of the underlying.
   *
   * <p>
  ...
  public void constructAppearances() {
    if (customAppearanceHandler == null) {
      final PDCaretAppearanceHandler appearanceHandler = new PDCaretAppearanceHandler(this);
