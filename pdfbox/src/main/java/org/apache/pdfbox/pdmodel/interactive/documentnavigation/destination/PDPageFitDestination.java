...
/**
 * This represents a destination to a page and the page contents will be
...
public class PDPageFitDestination extends PDPageDestination {
  ...
  public PDPageFitDestination() {
    super();
    array.growToSize(2);
    array.setName(1, PDPageFitDestination.TYPE);
  ...
  public boolean fitBoundingBox() {
    return PDPageFitDestination.TYPE_BOUNDED.equals(array.getName(1));
  }
  ...
  public void setFitBoundingBox(final boolean fitBoundingBox) {
    array.growToSize(2);
    if (fitBoundingBox) {
      array.setName(1, PDPageFitDestination.TYPE_BOUNDED);
    } else {
      array.setName(1, PDPageFitDestination.TYPE);
    }
  }
