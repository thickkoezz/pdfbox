...
public class PDDocumentNameDictionary implements COSObjectable {
  ...
  /**
   * Get the embedded files named tree node. The values in this name tree will be
  ...
  /**
   * Get the document level javascript entries. The values in this name tree will
   * be PDTextStream objects.
   *
