...
/**
 * This class will hold the current state of the text parameters when executing
 * a content stream.
 *
...
public class PDTextState implements Cloneable {
  ...
  /**
   * Get the value of the horizontalScaling. The default is 100. This value is the
   * percentage value 0-100 and not 0-1. So for mathematical operations you will
   * probably need to divide by 100 first.
   *
