...
public abstract class FDFAnnotation implements COSObjectable {
  ...
  public FDFAnnotation(final Element element) throws IOException {
    ...
    try {
      ...
      FDFAnnotation.LOG.debug("Error while evaluating XPath expression for richtext contents", e);
    }

    try {
      final Node richContents = (Node) xpath.evaluate("contents-richtext[1]", element, XPathConstants.NODE);
  ...
  public static FDFAnnotation create(final COSDictionary fdfDic) throws IOException {
    ...
    if (fdfDic != null) {
      if (FDFAnnotationText.SUBTYPE.equals(fdfDic.getNameAsString(COSName.SUBTYPE))) {
        ...
        FDFAnnotation.LOG
            .warn("Unknown or unsupported annotation type '" + fdfDic.getNameAsString(COSName.SUBTYPE) + "'");
      }
    }
    return retval;
  }
  ...
  public boolean isInvisible() {
    return annot.getFlag(COSName.F, FDFAnnotation.FLAG_INVISIBLE);
  }
  ...
  public final void setInvisible(final boolean invisible) {
    annot.setFlag(COSName.F, FDFAnnotation.FLAG_INVISIBLE, invisible);
  }
  ...
  public boolean isHidden() {
    return annot.getFlag(COSName.F, FDFAnnotation.FLAG_HIDDEN);
  }
  ...
  public final void setHidden(final boolean hidden) {
    annot.setFlag(COSName.F, FDFAnnotation.FLAG_HIDDEN, hidden);
  }
  ...
  public boolean isPrinted() {
    return annot.getFlag(COSName.F, FDFAnnotation.FLAG_PRINTED);
  }
  ...
  public final void setPrinted(final boolean printed) {
    annot.setFlag(COSName.F, FDFAnnotation.FLAG_PRINTED, printed);
  }
  ...
  public boolean isNoZoom() {
    return annot.getFlag(COSName.F, FDFAnnotation.FLAG_NO_ZOOM);
  }
  ...
  public final void setNoZoom(final boolean noZoom) {
    annot.setFlag(COSName.F, FDFAnnotation.FLAG_NO_ZOOM, noZoom);
  }
  ...
  public boolean isNoRotate() {
    return annot.getFlag(COSName.F, FDFAnnotation.FLAG_NO_ROTATE);
  }
  ...
  public final void setNoRotate(final boolean noRotate) {
    annot.setFlag(COSName.F, FDFAnnotation.FLAG_NO_ROTATE, noRotate);
  }
  ...
  public boolean isNoView() {
    return annot.getFlag(COSName.F, FDFAnnotation.FLAG_NO_VIEW);
  }
  ...
  public final void setNoView(final boolean noView) {
    annot.setFlag(COSName.F, FDFAnnotation.FLAG_NO_VIEW, noView);
  }
  ...
  public boolean isReadOnly() {
    return annot.getFlag(COSName.F, FDFAnnotation.FLAG_READ_ONLY);
  }
  ...
  public final void setReadOnly(final boolean readOnly) {
    annot.setFlag(COSName.F, FDFAnnotation.FLAG_READ_ONLY, readOnly);
  }
  ...
  public boolean isLocked() {
    return annot.getFlag(COSName.F, FDFAnnotation.FLAG_LOCKED);
  }
  ...
  public final void setLocked(final boolean locked) {
    annot.setFlag(COSName.F, FDFAnnotation.FLAG_LOCKED, locked);
  }
  ...
  public boolean isToggleNoView() {
    return annot.getFlag(COSName.F, FDFAnnotation.FLAG_TOGGLE_NO_VIEW);
  }
  ...
  public final void setToggleNoView(final boolean toggleNoView) {
    annot.setFlag(COSName.F, FDFAnnotation.FLAG_TOGGLE_NO_VIEW, toggleNoView);
  }
   ...
   *
   * @throws IOException If there is an error converting the string to a Calendar
   *                     object.
   */
   ...
   * pattern used in drawing the annotation.
   *
  ...
  /**
   * This will retrieve the border style dictionary, specifying the width and dash
   * pattern used in drawing the annotation.
   *
  ...
  /**
   * This will set the border effect dictionary, describing the effect applied to
   * the border described by the BS entry.
   *
  ...
  /**
   * This will retrieve the border style dictionary, describing the effect applied
  ...
  private String richContentsToString(final Node node, final boolean root) {
    ...
    return String.format("<%s%s>%s</%s>", node.getNodeName(), builder.toString(), subString, node.getNodeName());
  }
}