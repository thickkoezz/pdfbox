...
/**
 * A CalRGB colour space is a CIE-based colour space with one transformation
 * stage instead of two. In this type of space, A, B, and C represent calibrated
...
public class PDCalRGB extends PDCIEDictionaryBasedColorSpace {
  ...
  /**
   * Returns the gamma value. If none is present then the default of 1,1,1 will be
   * returned.
   *
   ...
   * If the underlying dictionary contains null then the identity matrix will be
   * returned.
   *
