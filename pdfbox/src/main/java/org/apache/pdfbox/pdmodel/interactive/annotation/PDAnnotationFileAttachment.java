...
public class PDAnnotationFileAttachment extends PDAnnotationMarkup {
  ...
  public PDAnnotationFileAttachment() {
    getCOSObject().setName(COSName.SUBTYPE, PDAnnotationFileAttachment.SUB_TYPE);
  }
  ...
  /**
   * This is the name used to draw the type of attachment. See the
   * ATTACHMENT_NAME_XXX constants.
   *
   * @return The name that describes the visual cue for the attachment.
   */
  public String getAttachmentName() {
    return getCOSObject().getNameAsString(COSName.NAME, PDAnnotationFileAttachment.ATTACHMENT_NAME_PUSH_PIN);
  }

  /**
   * Set the name used to draw the attachment icon. See the ATTACHMENT_NAME_XXX
   * constants.
   *
