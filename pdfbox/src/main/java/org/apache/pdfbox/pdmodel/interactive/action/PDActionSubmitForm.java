...
public class PDActionSubmitForm extends PDAction {
  ...
  public PDActionSubmitForm() {
    setSubType(PDActionSubmitForm.SUB_TYPE);
  }
  ...
  /**
   * An array identifying which fields to include in the submission or which to
  ...
  public COSArray getFields() {
    final COSBase retval = action.getDictionaryObject(COSName.FIELDS);
   ...
   */
  public int getFlags() {
    return action.getInt(COSName.FLAGS, 0);
  }
