...
public class PDThreadBead implements COSObjectable {
  ...
  /**
   * This will get the thread that this bead is part of. This is only required for
   * the first bead in a thread, so other beads 'may' return null.
   *
  ...
  /**
   * Set the thread that this bead is part of. This is only required for the first
   * bead in a thread. Note: This property is set for you by the
  ...
  /**
   * This will get the next bead. If this bead is the last bead in the list then
   * this will return the first bead.
   *
  ...
  /**
   * This will get the previous bead. If this bead is the first bead in the list
   * then this will return the last bead.
   *
   * @return The previous bead in the list or the last bead if this is the first
   *         bead.
   */
  ...
  /**
   * Append a bead after this bead. This will correctly set the next/previous
   * beads in the linked list.
   *
  ...
  /**
   * Set the page that this bead is part of. This is a required property and must
   * be set when creating a new bead. The PDPage object also has a list of beads
   * in the natural reading order. It is recommended that you add this object to
   * that list as well.
   *
