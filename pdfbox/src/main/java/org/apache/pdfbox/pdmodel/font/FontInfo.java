...
public abstract class FontInfo {
  ...
  /**
   * Returns a new FontBox font instance for the font. Implementors of this method
   * must not cache the return value of this method unless doing so via the
   * current {@link FontCache}.
   */
  ...
  /**
   * Returns the ulCodePageRange1 and ulCodePageRange1 field of the "OS/2" table,
   * or 0.
   */
  ...
  public String toString() {
    return getPostScriptName() + " (" + getFormat() + ", mac: 0x" + Integer.toHexString(getMacStyle()) + ", os/2: 0x"
