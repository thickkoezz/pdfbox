...
public class PDFTemplateCreator {
  ...
  public InputStream buildPDF(final PDVisibleSignDesigner properties) throws IOException {
    PDFTemplateCreator.LOG.info("pdf building has been started");
    ...
    final PDDocument template = pdfStructure.getTemplate();
    ...
    pdfBuilder.createImageForm(imageFormResources, innerFormResource, imageFormStream, bbox, transform,
    ...
    pdfBuilder.injectAppearanceStreams(holderFormStream, imageFormStream, imageFormStream, imageFormName, imageName,
    ...
    PDFTemplateCreator.LOG.info("stream returning started, size= " + in.available());
