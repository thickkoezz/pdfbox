...
/**
 * This is the class that represents a rubber stamp annotation. Introduced in
...
public class PDAnnotationRubberStamp extends PDAnnotationMarkup {
  ...
  /*
   * The various values of the rubber stamp as defined in the PDF 1.6 reference
   * Table 8.28
   */
  ...
  public PDAnnotationRubberStamp() {
    getCOSObject().setName(COSName.SUBTYPE, PDAnnotationRubberStamp.SUB_TYPE);
  }

  /**
   * Creates a Rubber Stamp annotation from a COSDictionary, expected to be a
  ...
  /**
   * This will set the name (and hence appearance, AP taking precedence) For this
   * annotation. See the NAME_XXX constants for valid values.
   *
  ...
  /**
   * This will retrieve the name (and hence appearance, AP taking precedence) For
   * this annotation. The default is DRAFT.
   *
   * @return The name of this rubber stamp, see the NAME_XXX constants.
   */
  public String getName() {
    return getCOSObject().getNameAsString(COSName.NAME, PDAnnotationRubberStamp.NAME_DRAFT);
  }
}
