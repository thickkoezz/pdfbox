 ...
 * An object reference.
 * <p>
 * This is described as "Entries in an object reference dictionary" in the PDF
 * specification.
 *
...
public class PDObjectReference implements COSObjectable {
  ...
  public PDObjectReference() {
    ...
    dictionary.setName(COSName.TYPE, PDObjectReference.TYPE);
  }
  ...
  /**
   * Gets a higher-level object for the referenced object. Currently this method
   * may return a {@link PDAnnotation}, a {@link PDXObject} or <code>null</code>.
   *
   * @return a higher-level object for the referenced object
   */
  public COSObjectable getReferencedObject() {
    final COSBase obj = getCOSObject().getDictionaryObject(COSName.OBJ);
    ...
    try {
       ...
       * COSName.TYPE is not COSName.ANNOT it still may be an annotation. TODO shall
       * we return the annotation object instead of null? what else can be the target
      ...
      PDObjectReference.LOG.debug("Couldn't get the referenced object - returning null instead", exception);
