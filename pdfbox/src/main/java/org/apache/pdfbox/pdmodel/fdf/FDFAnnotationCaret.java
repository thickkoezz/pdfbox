...
public class FDFAnnotationCaret extends FDFAnnotation {
  ...
  public FDFAnnotationCaret() {
    super();
    annot.setName(COSName.SUBTYPE, FDFAnnotationCaret.SUBTYPE);
  }
   ...
   * annotations rectangle and where the drawing occurs.
   *
  ...
  /**
   * This will retrieve the fringe. Giving the difference between the annotations
   * rectangle and where the drawing occurs.
   *
