...
public interface PDVectorFont {
  ...
  /**
   * Returns the normalized glyph path for the given character code in a PDF. The
   * resulting path is normalized to the PostScript 1000 unit square, and fallback
   * glyphs are returned where appropriate, e.g. for missing glyphs.
   *
   * @param code character code in a PDF. Not to be confused with unicode.
   * @throws java.io.IOException if the font could not be read
   */
  ...
  /**
   * Returns true if this font contains a glyph for the given character code in a
   * PDF.
   *
   * @param code character code in a PDF. Not to be confused with unicode.
   */
