...
public class PDCryptFilterDictionary implements COSObjectable {
   ...
   *
   * @param d the low level dictionary that will be managed by the newly created
   *          object
   */
   ...
   * <br>
   * The length in <b>bits</b> for the crypt filter algorithm. This will return a
   * multiple of 8.
   *
  ...
  /**
   * This will return the crypt filter method. Allowed values are: NONE, V2,
   * AESV2, AESV3
   *
