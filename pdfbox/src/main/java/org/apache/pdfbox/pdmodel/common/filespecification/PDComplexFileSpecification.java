...
public class PDComplexFileSpecification extends PDFileSpecification {
  ...
  /**
   * This will set the unicode file name. If you call this, then do not forget to
   * also call {@link #setFile(java.lang.String) setFile(String)} or the
   * attachment will not be visible on some viewers.
   *
   ...
   * {@link #setFileUnicode(java.lang.String) setFileUnicode(String)} for
   ...
   *
   * @param file The name of the file.
   * @deprecated This method is obsolescent and should not be used by conforming
   *             writers.
   */
  @Deprecated
  ...
  public PDEmbeddedFile getEmbeddedFile() {
    ...
    final COSStream stream = (COSStream) getObjectFromEFDictionary(COSName.F);
    if (stream != null) {
  ...
  public PDEmbeddedFile getEmbeddedFileDos() {
    PDEmbeddedFile file = null;
    final COSStream stream = (COSStream) getObjectFromEFDictionary(COSName.DOS);
    if (stream != null) {
      file = new PDEmbeddedFile(stream);
    }
    return file;
  ...
  public PDEmbeddedFile getEmbeddedFileMac() {
    PDEmbeddedFile file = null;
    final COSStream stream = (COSStream) getObjectFromEFDictionary(COSName.MAC);
    if (stream != null) {
      file = new PDEmbeddedFile(stream);
    }
    return file;
  ...
  public PDEmbeddedFile getEmbeddedFileUnix() {
    PDEmbeddedFile file = null;
    final COSStream stream = (COSStream) getObjectFromEFDictionary(COSName.UNIX);
    if (stream != null) {
      file = new PDEmbeddedFile(stream);
    }
    return file;
  ...
  public PDEmbeddedFile getEmbeddedFileUnicode() {
    PDEmbeddedFile file = null;
    final COSStream stream = (COSStream) getObjectFromEFDictionary(COSName.UF);
    if (stream != null) {
      file = new PDEmbeddedFile(stream);
    }
    return file;
  ...
  /**
   * Set the embedded Unicode file for this spec. If you call this, then do not
   * forget to also call
   * {@link #setEmbeddedFile(org.apache.pdfbox.pdmodel.common.filespecification.PDEmbeddedFile)
   * setEmbeddedFile(PDEmbeddedFile)} or the attachment will not be visible on
   * some viewers.
   *
