...
/**
 * Parser for PDF Type 4 functions. This implements a small subset of the
 * PostScript language but is no full PostScript interpreter.
 *
 */
public final class Parser {
  ...
  /**
   * Parses a Type 4 function and sends the syntactic elements to the given syntax
   * handler.
   *
  ...
  public interface SyntaxHandler {
    ...
    /**
     * Called when a token is encountered. No distinction between operators and
     * values is done here.
     *
  ...
  private static final class Tokenizer {
    ...
    private void scanNewLine() {
      ...
      final char ch = currentChar();
      buffer.append(ch);
      if (ch == Tokenizer.CR && peek() == Tokenizer.LF) {
