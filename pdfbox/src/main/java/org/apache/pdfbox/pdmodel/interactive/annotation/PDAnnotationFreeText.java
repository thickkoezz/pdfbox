...
public class PDAnnotationFreeText extends PDAnnotationMarkup {
  ...
  /**
   * A callout, associated with an area on the page through the callout line
   * specified.
   */
  ...
  public PDAnnotationFreeText() {
    getCOSObject().setName(COSName.SUBTYPE, PDAnnotationFreeText.SUB_TYPE);
  }

  /**
   * Creates a FreeText annotation from a COSDictionary, expected to be a correct
   * object definition.
   *
  ...
  /**
   * This will set the quadding/justification of the text. Please see the
   * QUADDING_CONSTANTS in {@link PDVariableText }.
   *
  ...
  /**
   * This will set the coordinates of the callout line. (PDF 1.6 and higher) Only
   * relevant if the intent is FreeTextCallout.
   *
   * @param callout An array of four or six numbers specifying a callout line
   *                attached to the free text annotation. Six numbers [ x1 y1 x2
   *                y2 x3 y3 ] represent the starting, knee point, and ending
   *                coordinates of the line in default user space, four numbers [
   *                x1 y1 x2 y2 ] represent the starting and ending coordinates of
   *                the line.
   */
  ...
  /**
   * This will get the coordinates of the callout line. (PDF 1.6 and higher) Only
   * relevant if the intent is FreeTextCallout.
   *
   * @return An array of four or six numbers specifying a callout line attached to
   *         the free text annotation. Six numbers [ x1 y1 x2 y2 x3 y3 ] represent
   *         the starting, knee point, and ending coordinates of the line in
   *         default user space, four numbers [ x1 y1 x2 y2 ] represent the
   ...
   *
   * @return The line ending style, possible values shown in the LE_ constants
   *         section, LE_NONE if missing, never null.
   */
   ...
   * when drawing the line. This is supported by PDF 1.6 and higher.
   *
  ...
  public void constructAppearances() {
    if (customAppearanceHandler == null) {
      final PDFreeTextAppearanceHandler appearanceHandler = new PDFreeTextAppearanceHandler(this);
