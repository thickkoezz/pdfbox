...
public class PDActionLaunch extends PDAction {
  ...
  public PDActionLaunch() {
    setSubType(PDActionLaunch.SUB_TYPE);
  }
  ...
  /**
   * This will get the application to be launched or the document to be opened or
   * printed. It is required if none of the entries Win, Mac or Unix is present.
   * If this entry is absent and the viewer application does not understand any of
   * the alternative entries it should do nothing.
   *
  ...
  /**
   * This will set the application to be launched or the document to be opened or
   * printed. It is required if none of the entries Win, Mac or Unix is present.
   * If this entry is absent and the viewer application does not understand any of
   * the alternative entries it should do nothing.
   *
  ...
  /**
   * This will get the file name to be launched or the document to be opened or
   * printed, in standard Windows pathname format. If the name string includes a
   * backslash character (\), the backslash must itself be preceded by a
   * backslash. This value must be a single string; it is not a file
   * specification.
   *
  ...
  /**
   * This will set the file name to be launched or the document to be opened or
   * printed, in standard Windows pathname format. If the name string includes a
   * backslash character (\), the backslash must itself be preceded by a
   * backslash. This value must be a single string; it is not a file
   * specification.
  ...
  /**
   * This will get the string specifying the default directory in standard DOS
   * syntax.
   *
  ...
  /**
   * This will set the string specifying the default directory in standard DOS
   * syntax.
   *
  ...
  /**
   * This will get the string specifying the operation to perform: open to open a
   * document print to print a document If the F entry designates an application
   * instead of a document, this entry is ignored and the application is launched.
   * Default value: open.
   *
  ...
  /**
   * This will set the string specifying the operation to perform: open to open a
   * document print to print a document If the F entry designates an application
   * instead of a document, this entry is ignored and the application is launched.
   * Default value: open.
   *
  ...
  /**
   * This will get a parameter string to be passed to the application designated
   * by the F entry. This entry should be omitted if F designates a document.
   *
  ...
  /**
   * This will set a parameter string to be passed to the application designated
   * by the F entry. This entry should be omitted if F designates a document.
   *
   ...
   * in the same window, or behave in accordance with the current user preference.
   *
