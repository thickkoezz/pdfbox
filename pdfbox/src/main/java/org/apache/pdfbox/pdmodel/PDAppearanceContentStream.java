...
public final class PDAppearanceContentStream extends PDAbstractContentStream implements Closeable {
   ...
   * @param components the color components dependent on the color space being
   *                   used.
   * @throws IOException If there is an error writing to the content stream.
   */
   ...
   * @throws IOException If there is an error writing to the content stream.
   */
  public void setBorderLine(final float lineWidth, final PDBorderStyleDictionary bs, final COSArray border)
      throws IOException {
