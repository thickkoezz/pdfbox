...
/**
 * This class represents an annotation's dictionary of actions that occur due to
 * events.
 *
...
public class PDAnnotationAdditionalActions implements COSObjectable {
  ...
  /**
   * This will get an action to be performed when the cursor enters the
  ...
  /**
   * This will set an action to be performed when the cursor enters the
   * annotation's active area.
   *
  ...
  /**
   * This will get an action to be performed when the cursor exits the
   * annotation's active area.
   *
  ...
  /**
   * This will set an action to be performed when the cursor exits the
   * annotation's active area.
   *
  ...
  /**
   * This will get an action to be performed when the mouse button is pressed
  ...
  /**
   * This will set an action to be performed when the mouse button is pressed
   * inside the annotation's active area. The name D stands for "down".
   *
  ...
  /**
   * This will get an action to be performed when the mouse button is released
  ...
  /**
   * This will set an action to be performed when the mouse button is released
   * inside the annotation's active area. The name U stands for "up".
   *
  ...
  /**
   * This will get an action to be performed when the annotation receives the
   * input focus.
   *
  ...
  /**
   * This will set an action to be performed when the annotation receives the
   * input focus.
   *
  ...
  /**
   * This will get an action to be performed when the annotation loses the input
   * focus. The name Bl stands for "blurred".
   *
  ...
  /**
   * This will set an action to be performed when the annotation loses the input
   * focus. The name Bl stands for "blurred".
   *
  ...
  /**
   * This will get an action to be performed when the page containing the
   * annotation is opened. The action is executed after the O action in the page's
   * additional actions dictionary and the OpenAction entry in the document
   * catalog, if such actions are present.
   *
  ...
  /**
   * This will set an action to be performed when the page containing the
   * annotation is opened. The action is executed after the O action in the page's
   * additional actions dictionary and the OpenAction entry in the document
   * catalog, if such actions are present.
   *
  ...
  /**
   * This will get an action to be performed when the page containing the
   * annotation is closed. The action is executed before the C action in the
  ...
  /**
   * This will get an action to be performed when the page containing the
   * annotation is no longer visible in the viewer application's user interface.
   *
