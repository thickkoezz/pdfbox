 ...
 * document. It contains a low level dictionary (COSDictionary) and provides the
 * methods to manage its fields.
 *
 * The available fields are the ones who are involved by standard security
 * handler and public key security handler.
 *
...
public class PDEncryption implements COSObjectable {
   ...
   */
  public static final int DEFAULT_VERSION = PDEncryption.VERSION0_UNDOCUMENTED_UNSUPPORTED;
   ...
   * @throws IOException if there is no security handler available which matches
   *                     the Filter
   */
  ...
  /**
   * Returns true if the security handler specified in the dictionary's Filter is
   * available.
   *
   ...
   * <br>
   * <b>Note: This value is used to decrypt the pdf document. If you change this
   * when the document is encrypted then decryption will fail!.</b>
   *
   ...
   * <br>
   * The length in <b>bits</b> for the encryption algorithm. This will return a
   * multiple of 8.
   *
  ...
  public int getRevision() {
    return dictionary.getInt(COSName.R, PDEncryption.DEFAULT_VERSION);
  }
   ...
   *
   * @return true if EncryptMetaData is explicitly set to false (the default is
   *         true)
   */
  ...
  /**
   * This will set the Recipients field of the dictionary. This field contains an
   * array of string.
   *
   ...
   *
   * @return a COSString object containing information about the recipient number
   *         i.
   */
   ...
   */
  public void setCryptFilterDictionary(final COSName cryptFilterName,
      final PDCryptFilterDictionary cryptFilterDictionary) {
