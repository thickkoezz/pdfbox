...
/**
 * Base class for fields which use "Variable Text". These fields construct an
...
public abstract class PDVariableText extends PDTerminalField {
   ...
   *
   * This will set the local default appearance for the variable text field only,
   * not affecting a default appearance in the parent hierarchy.
   *
   * Providing null as the value will remove the local default appearance.
   * <p>
   * This method can also be used to change the font of a field, by replacing the
   * font name from this string with another font name found in the AcroForm
   * default resources <u>before</u> calling {@link #setValue(java.lang.String)
   * setValue(String)}, see also <a href=
   * "https://stackoverflow.com/questions/47995062/pdfbox-api-how-to-handle-cyrillic-values">this
   * stackoverflow answer</a>. For example, "/Helv 10 Tf 0 g" can be replaced with
   * "/F1 10 Tf 0 g". Performance may go down (see
   * <a href="https://issues.apache.org/jira/browse/PDFBOX-4508">PDFBOX-4508)</a>
   * if this is done for many fields and with a very large font (e.g. ArialUni);
   * to avoid this, save and reload the file after changing all fields.
   *
   ...
   *
   * This is an inheritable attribute. <br>
   * 0 - Left (default)<br>
   * 1 - Centered<br>
   * 2 - Right<br>
   ...
   * <br>
   * You can set {@link PDAcroForm#setNeedAppearances(Boolean)} to signal a
   * conforming reader to generate the appearance stream.
   * </p>
   *
   * Providing null as the value will remove the default style string.
   *
