...
public class PDAnnotationLink extends PDAnnotation {
  ...
  public PDAnnotationLink() {
    getCOSObject().setName(COSName.SUBTYPE, PDAnnotationLink.SUB_TYPE);
  }

  /**
   * Creates a Link annotation from a COSDictionary, expected to be a correct
   * object definition.
   *
   ...
   * Either this or the destination entry should be set, but not both.
   *
  ...
  /**
   * Set the annotation action. Either this or the destination entry should be
   * set, but not both.
   *
   ...
   * this or the action entry should be set, but not both.
   *
  ...
  /**
   * The new destination value. Either this or the action entry should be set, but
   * not both.
   *
  ...
  /**
   * Set the highlight mode for when the mouse is depressed. See the
   * HIGHLIGHT_MODE_XXX constants.
   *
   * @return The string representation of the highlight mode.
   */
  public String getHighlightMode() {
    return getCOSObject().getNameAsString(COSName.H, PDAnnotationLink.HIGHLIGHT_MODE_INVERT);
  }
  ...
  /**
   * This will set the previous URI action, in case it needs to be retrieved at
   * later date.
   *
  ...
  public void constructAppearances() {
    if (customAppearanceHandler == null) {
      final PDLinkAppearanceHandler appearanceHandler = new PDLinkAppearanceHandler(this);
