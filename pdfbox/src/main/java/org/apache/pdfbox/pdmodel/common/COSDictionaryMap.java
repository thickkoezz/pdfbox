...
public class COSDictionaryMap<K, V> implements Map<K, V> {
  ...
  /**
   * This will take a
   * map&lt;java.lang.String,org.apache.pdfbox.pdmodel.COSObjectable&gt; and
   * convert it into a COSDictionary.
   *
  ...
  public static COSDictionary convert(final Map<String, ?> someMap) {
    ...
    for (final Entry<String, ?> entry : someMap.entrySet()) {
      final String name = entry.getKey();
      final COSObjectable object = (COSObjectable) entry.getValue();
