...
public class PDRectlinearMeasureDictionary extends PDMeasureDictionary {
  ...
  public PDRectlinearMeasureDictionary() {
    setSubtype(PDRectlinearMeasureDictionary.SUBTYPE);
  }
  ...
  public PDNumberFormatDictionary[] getChangeXs() {
    final COSArray x = (COSArray) getCOSObject().getDictionaryObject("X");
    if (x != null) {
  ...
  public PDNumberFormatDictionary[] getChangeYs() {
    final COSArray y = (COSArray) getCOSObject().getDictionaryObject("Y");
    if (y != null) {
  ...
  public PDNumberFormatDictionary[] getDistances() {
    final COSArray d = (COSArray) getCOSObject().getDictionaryObject("D");
    if (d != null) {
  ...
  public PDNumberFormatDictionary[] getAreas() {
    final COSArray a = (COSArray) getCOSObject().getDictionaryObject(COSName.A);
    if (a != null) {
  ...
  public PDNumberFormatDictionary[] getAngles() {
    final COSArray t = (COSArray) getCOSObject().getDictionaryObject("T");
    if (t != null) {
  ...
  public PDNumberFormatDictionary[] getLineSloaps() {
    final COSArray s = (COSArray) getCOSObject().getDictionaryObject("S");
    if (s != null) {
  ...
  public float[] getCoordSystemOrigin() {
    final COSArray o = (COSArray) getCOSObject().getDictionaryObject("O");
    if (o != null)
