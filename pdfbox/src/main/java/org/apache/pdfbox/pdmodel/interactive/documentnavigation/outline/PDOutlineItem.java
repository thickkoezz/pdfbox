...
/**
 * This represents an outline item in a pdf document. The items at each level of
 * the hierarchy form an iterable linked list, chained together through their
...
public final class PDOutlineItem extends PDOutlineNode {
   ...
   *                                  (i.e. if it has a previous or a next
   *                                  sibling)
   */
  ...
  /**
   * A convenience method that will create an XYZ destination using only the
   * defaults.
   *
   ...
   * outline points to. If the outline does not point to anything then this method
   * will return null. If the outline is an action that is not a GoTo action then
   * this method will also return null.
   *
   * @param doc The document to get the page from.
   *
   * @return The page that this outline will go to when activated or null if it
  ...
  /**
   * Get the RGB text color of this node. Default is black and this method will
   * never return null.
   *
   * @return The structure element of this node.
   */
  ...
  public boolean isItalic() {
    return getCOSObject().getFlag(COSName.F, PDOutlineItem.ITALIC_FLAG);
  }
  ...
  public void setItalic(final boolean italic) {
    getCOSObject().setFlag(COSName.F, PDOutlineItem.ITALIC_FLAG, italic);
  }
  ...
  public boolean isBold() {
    return getCOSObject().getFlag(COSName.F, PDOutlineItem.BOLD_FLAG);
  }
  ...
  public void setBold(final boolean bold) {
    getCOSObject().setFlag(COSName.F, PDOutlineItem.BOLD_FLAG, bold);
  }
