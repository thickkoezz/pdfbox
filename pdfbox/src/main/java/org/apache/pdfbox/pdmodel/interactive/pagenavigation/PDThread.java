...
public class PDThread implements COSObjectable {
  ...
  /**
   * Get the first bead in the thread, or null if it has not been set yet. This is
   * a required field for this object.
   *
  ...
  /**
   * This will set the first bead in the thread. When this is set it will also set
   * the thread property of the bead object.
   *
