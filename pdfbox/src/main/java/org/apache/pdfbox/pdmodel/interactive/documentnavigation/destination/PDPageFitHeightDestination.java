...
/**
 * This represents a destination to a page at a x location and the height is
...
public class PDPageFitHeightDestination extends PDPageDestination {
  ...
  public PDPageFitHeightDestination() {
    super();
    array.growToSize(3);
    array.setName(1, PDPageFitHeightDestination.TYPE);
  ...
  /**
   * A flag indicating if this page destination should just fit bounding box of
   * the PDF.
   *
   * @return true If the destination should fit just the bounding box.
   */
  public boolean fitBoundingBox() {
    return PDPageFitHeightDestination.TYPE_BOUNDED.equals(array.getName(1));
  }

  /**
   * Set if this page destination should just fit the bounding box. The default is
   * false.
   *
  ...
  public void setFitBoundingBox(final boolean fitBoundingBox) {
    array.growToSize(2);
    if (fitBoundingBox) {
      array.setName(1, PDPageFitHeightDestination.TYPE_BOUNDED);
    } else {
      array.setName(1, PDPageFitHeightDestination.TYPE);
    }
  }
