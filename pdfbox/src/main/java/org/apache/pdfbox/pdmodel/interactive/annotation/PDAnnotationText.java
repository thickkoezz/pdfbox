...
public class PDAnnotationText extends PDAnnotationMarkup {
  ...
  public PDAnnotationText() {
    getCOSObject().setName(COSName.SUBTYPE, PDAnnotationText.SUB_TYPE);
  }
   ...
   * this annotation. The default is NOTE.
   *
   * @return The name of this annotation, see the NAME_XXX constants.
   */
  public String getName() {
    return getCOSObject().getNameAsString(COSName.NAME, PDAnnotationText.NAME_NOTE);
  }
  ...
  /**
   * This will set the annotation state model. Allowed values are "Marked" and
   * "Review"
   *
  ...
  public void constructAppearances() {
    if (customAppearanceHandler == null) {
      final PDTextAppearanceHandler appearanceHandler = new PDTextAppearanceHandler(this);
