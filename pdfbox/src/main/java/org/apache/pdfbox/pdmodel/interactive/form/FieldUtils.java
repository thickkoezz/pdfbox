...
/**
 * A set of utility methods to help with common AcroForm form and field related
 * functions.
 */
public final class FieldUtils {
   ...
   *
   * This implementation is used to help sorting the content of field option
   * entries with an array of two-element arrays as used by choice fields.
   *
   */
   ...
   * <p>
   * Some entries in a dictionary can either be an array of elements or an array
   * of two-element arrays. This method will either return the elements in the
   * array or in case of two-element arrays, the element designated by the pair
   * index
   * </p>
   * <p>
