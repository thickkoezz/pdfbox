...
/**
 * The MarkInfo provides additional information relevant to specialized uses of
...
public class PDMarkInfo implements COSObjectable {
  ...
  /**
   * Tells if this PDF contain 'suspect' tags. See PDF Reference 1.6 section 10.6
   * "Logical Structure" for more information about this property.
   *
  ...
  /**
   * Set the value of the suspects property. See PDF Reference 1.6 section 10.6
   * "Logical Structure" for more information about this property.
   *
