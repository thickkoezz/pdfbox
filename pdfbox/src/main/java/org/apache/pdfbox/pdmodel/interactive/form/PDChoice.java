...
/**
 * A choice field contains several text items, one or more of which shall be
...
public abstract class PDChoice extends PDVariableText {
   ...
   *
   * <p>
   * For a choice field the options array can either be an array of text strings
   * or an array of a two-element arrays.<br>
   * The method always only returns either the text strings or, in case of
   * two-element arrays, an array of the first element of the two-element arrays
   * </p>
   * <p>
   ...
   *
   * <p>
   * The Opt array specifies the list of options in the choice field either as an
   * array of text strings representing the display value or as an array of a
   * two-element array where the first element is the export value and the second
   * the display value.
   * </p>
   * <p>
   * To set both the export and the display value use
   * {@link #setOptions(List, List)}
   * </p>
   *
   ...
   *
   * <p>
   * This will set both, the export value and the display value of the choice
   * field. If either one of the parameters is null or an empty list is supplied
   * the options will be removed.
   * </p>
   * <p>
   * An {@link IllegalArgumentException} will be thrown if the number of items in
   * the list differ.
   * </p>
   *
   * @see #setOptions(List)
   ...
   * For options with an array of text strings the display value and export value
   * are the same.<br>
   * For options with an array of two-element arrays the export value is the first
   ...
   * <p>
   * This is only needed if a choice field allows multiple selections and two
   * different items have the same export value or more than one values is
   * selected.
   * </p>
   * <p>
   ...
   *
   * <p>
   * If set, the field’s option items shall be sorted alphabetically. The sorting
   * has to be done when writing the PDF. PDF Readers are supposed to display the
  ...
  public boolean isSort() {
    return getCOSObject().getFlag(COSName.FF, PDChoice.FLAG_SORT);
  }
  ...
  public void setSort(final boolean sort) {
    getCOSObject().setFlag(COSName.FF, PDChoice.FLAG_SORT, sort);
  }
  ...
  public boolean isMultiSelect() {
    return getCOSObject().getFlag(COSName.FF, PDChoice.FLAG_MULTI_SELECT);
  }
  ...
  public void setMultiSelect(final boolean multiSelect) {
    getCOSObject().setFlag(COSName.FF, PDChoice.FLAG_MULTI_SELECT, multiSelect);
  }
  ...
  public boolean isDoNotSpellCheck() {
    return getCOSObject().getFlag(COSName.FF, PDChoice.FLAG_DO_NOT_SPELL_CHECK);
  }
  ...
  public void setDoNotSpellCheck(final boolean doNotSpellCheck) {
    getCOSObject().setFlag(COSName.FF, PDChoice.FLAG_DO_NOT_SPELL_CHECK, doNotSpellCheck);
  }
  ...
  public boolean isCommitOnSelChange() {
    return getCOSObject().getFlag(COSName.FF, PDChoice.FLAG_COMMIT_ON_SEL_CHANGE);
  }
  ...
  public void setCommitOnSelChange(final boolean commitOnSelChange) {
    getCOSObject().setFlag(COSName.FF, PDChoice.FLAG_COMMIT_ON_SEL_CHANGE, commitOnSelChange);
  }
  ...
  public boolean isCombo() {
    return getCOSObject().getFlag(COSName.FF, PDChoice.FLAG_COMBO);
  }
  ...
  public void setCombo(final boolean combo) {
    getCOSObject().setFlag(COSName.FF, PDChoice.FLAG_COMBO, combo);
  }

  /**
   * Set the selected value of this field, and try to update the visual
   * appearance.
   *
  ...
  /**
   * Sets the entry "V" to the given values. Requires {@link #isMultiSelect()} to
   * be true.
   *
  ...
  /**
   * Returns the selected values, or an empty List. This list always contains a
   * single item unless {@link #isMultiSelect()} is true.
   *
  ...
  /**
   * Returns the default values, or an empty List. This list always contains a
   * single item unless {@link #isMultiSelect()} is true.
   *
   * @return A non-null string.
   */
