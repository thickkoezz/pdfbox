...
/**
 * A line dash pattern for stroking paths. Instances of PDLineDashPattern are
 * immutable.
 *
...
public final class PDLineDashPattern implements COSObjectable {
  ...
  /**
   * Returns the dash phase. This specifies the distance into the dash pattern at
   * which to start the dash.
   *
