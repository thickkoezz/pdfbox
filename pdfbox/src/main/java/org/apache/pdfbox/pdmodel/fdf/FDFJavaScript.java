...
/**
 * This represents an FDF JavaScript dictionary that is part of the FDF
 * document.
 *
...
public class FDFJavaScript implements COSObjectable {
  ...
  /**
   * Returns the dictionary's "Doc" entry, that is, a map of key value pairs to be
   * added to the document's JavaScript name tree.
   *
  ...
  public void setDoc(final Map<String, PDActionJavaScript> map) {
    ...
    for (final Map.Entry<String, PDActionJavaScript> entry : map.entrySet()) {
