...
public class PDPageLabelRange implements COSObjectable {
  ...
  public String getStyle() {
    return root.getNameAsString(PDPageLabelRange.KEY_STYLE);
  }
  ...
  public void setStyle(final String style) {
    if (style != null) {
      root.setName(PDPageLabelRange.KEY_STYLE, style);
    } else {
      root.removeItem(PDPageLabelRange.KEY_STYLE);
    }
  }
   ...
   */
  public int getStart() {
    return root.getInt(PDPageLabelRange.KEY_START, 1);
  }
  ...
  public void setStart(final int start) {
    ...
    root.setInt(PDPageLabelRange.KEY_START, start);
  }
  ...
  public String getPrefix() {
    return root.getString(PDPageLabelRange.KEY_PREFIX);
  }
  ...
  public void setPrefix(final String prefix) {
    if (prefix != null) {
      root.setString(PDPageLabelRange.KEY_PREFIX, prefix);
    } else {
      root.removeItem(PDPageLabelRange.KEY_PREFIX);
    }
  }
}
