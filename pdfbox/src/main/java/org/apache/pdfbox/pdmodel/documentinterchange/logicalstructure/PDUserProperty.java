...
public class PDUserProperty extends PDDictionaryWrapper {
   ...
   *
   * @return <code>true</code> if the property shall be hidden, <code>false</code>
   *         otherwise
   */
  ...
  public String toString() {
    return "Name=" + getName() + ", Value=" + getValue() + ", FormattedValue=" + getFormattedValue() + ", Hidden="
        + isHidden();
  }
  ...
  private void potentiallyNotifyChanged(final Object oldEntry, final Object newEntry) {
    if (isEntryChanged(oldEntry, newEntry)) {
      userAttributeObject.userPropertyChanged(this);
    }
  }
  ...
  public int hashCode() {
    ...
    result = prime * result + (userAttributeObject == null ? 0 : userAttributeObject.hashCode());
    return result;
  }
