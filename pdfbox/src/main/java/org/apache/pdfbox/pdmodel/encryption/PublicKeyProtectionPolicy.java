 ...
 *
 * The following code sample shows how to protect a document using the public
 * key security handler. In this code sample, <code>doc</code> is a
...
public final class PublicKeyProtectionPolicy extends ProtectionPolicy {
  ...
  /**
   * Returns an iterator to browse the list of recipients. Object found in this
   * iterator are <code>PublicKeyRecipient</code>.
   *
