...
public class PDActionSound extends PDAction {
  ...
  public PDActionSound() {
    setSubType(PDActionSound.SUB_TYPE);
  }
   ...
   *
   * @param volume The volume at which to play the sound, in the range −1.0 to
   *               1.0.
   *
   * @throws IllegalArgumentException if the volume parameter is outside of the
   *                                  range −1.0 to 1.0.
   */
   ...
   * Sets the volume.
   *
   * @return The volume at which to play the sound, in the range −1.0 to 1.0.
   *         Default value: 1.0.
   */
   ...
   * When true, the reader allows no further user interaction other than canceling
   * the sound until the sound has been completely played.
   *
   * @param synchronous Whether to play the sound synchronously (true) or
   ...
   * synchronously or asynchronously. When true, the reader allows no further user
   * interaction other than canceling the sound until the sound has been
   * completely played.
   *
   * @return Whether to play the sound synchronously (true) or asynchronously
   *         (false, also the default).
   */
  ...
  /**
   * The flag specifying whether to mix this sound with any other sound already
   * playing. If this flag is false, any previously playing sound shall be stopped
   * before starting this sound; this can be used to stop a repeating sound (see
   ...
   * already playing. If this flag is false, any previously playing sound shall be
   * stopped before starting this sound; this can be used to stop a repeating
   * sound (see Repeat).
   *
   * @return whether to mix this sound with any other sound already playing
   *         (default: false).
   */
