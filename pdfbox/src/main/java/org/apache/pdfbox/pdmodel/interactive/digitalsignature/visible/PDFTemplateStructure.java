...
public class PDFTemplateStructure {
  ...
  /**
   * Gets PDDocument template. This represents a digital signature that can be
  ...
  /**
   * Wets PDDocument template. This represents a digital signature that can be
   * attached to a document
   *
   * @param template
   */
  ...
  /**
   * Acroform have its Dictionary, so we here set the Dictionary which is in this
   * location: <b> AcroForm/DR </b>
   *
  ...
  /**
   * Gets Holder form. That form is here <b> AcroForm/DR/XObject/{holder form
   * name} </b> By default, name stars with FRM. We also add number of form to the
   * name.
   *
  ...
  /**
   * In the structure, form will be contained by XObject in the <b>AcroForm/DR/
   * </b>
   *
   * @param holderForm
   */
  ...
  /**
   * Gets inner form that is in this location: <b> AcroForm/DR/XObject/{holder
   * form name}/Resources/XObject/{inner name} </b> By default inner form name
   * starts with "n". Then we add number of form to the name.
   *
  ...
  /**
   * sets inner form to this location: <b> AcroForm/DR/XObject/{holder form
   * name}/Resources/XObject/{destination} </b>
   *
   * @param innerForm
   */
  ...
  /**
   * Gets Image form. Image form is in this structure: <b>/AcroForm/DR/{holder
   * form}/Resources/XObject /{inner form} </b> /Resources/XObject/{image form
   * name}.
   *
   ...
   * /Resources/XObject/{image form name}.</b> By default we start image form name
   * with "img". Then we add number of image form to the form name. Sets image
   * form
   *
   * @param imageForm
   */
