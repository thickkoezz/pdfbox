...
/**
 * This represents a destination to a page at a y location and the width is
 * magnified to just fit on the screen.
 *
...
public class PDPageFitRectangleDestination extends PDPageDestination {
  ...
  public PDPageFitRectangleDestination() {
    super();
    array.growToSize(6);
    array.setName(1, PDPageFitRectangleDestination.TYPE);
  ...
  /**
   * Get the left x coordinate. A return value of -1 implies that the current
  ...
  /**
   * Set the left x-coordinate, a value of -1 implies that the current
   * x-coordinate will be used.
   *
  ...
  /**
   * Get the bottom y coordinate. A return value of -1 implies that the current
  ...
  /**
   * Set the bottom y-coordinate, a value of -1 implies that the current
   * y-coordinate will be used.
   *
  ...
  /**
   * Get the right x coordinate. A return value of -1 implies that the current
   * x-coordinate will be used.
   *
  ...
  /**
   * Set the right x-coordinate, a value of -1 implies that the current
   * x-coordinate will be used.
   *
  ...
  /**
   * Get the top y coordinate. A return value of -1 implies that the current
   * y-coordinate will be used.
   *
