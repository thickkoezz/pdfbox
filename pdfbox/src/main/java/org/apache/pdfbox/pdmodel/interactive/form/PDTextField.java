...
/**
 * A text field is a box or space for text fill-in data typically entered from a
 * keyboard. The text may be restricted to a single line or may be permitted to
 * span multiple lines
 *
 * @author sug
 */
public final class PDTextField extends PDVariableText {
  ...
  public boolean isMultiline() {
    return getCOSObject().getFlag(COSName.FF, PDTextField.FLAG_MULTILINE);
  }
  ...
  public void setMultiline(final boolean multiline) {
    getCOSObject().setFlag(COSName.FF, PDTextField.FLAG_MULTILINE, multiline);
  }
  ...
  public boolean isPassword() {
    return getCOSObject().getFlag(COSName.FF, PDTextField.FLAG_PASSWORD);
  }
  ...
  public void setPassword(final boolean password) {
    getCOSObject().setFlag(COSName.FF, PDTextField.FLAG_PASSWORD, password);
  }
  ...
  public boolean isFileSelect() {
    return getCOSObject().getFlag(COSName.FF, PDTextField.FLAG_FILE_SELECT);
  }
  ...
  public void setFileSelect(final boolean fileSelect) {
    getCOSObject().setFlag(COSName.FF, PDTextField.FLAG_FILE_SELECT, fileSelect);
  }
  ...
  public boolean doNotSpellCheck() {
    return getCOSObject().getFlag(COSName.FF, PDTextField.FLAG_DO_NOT_SPELL_CHECK);
  }
  ...
  public void setDoNotSpellCheck(final boolean doNotSpellCheck) {
    getCOSObject().setFlag(COSName.FF, PDTextField.FLAG_DO_NOT_SPELL_CHECK, doNotSpellCheck);
  }
  ...
  public boolean doNotScroll() {
    return getCOSObject().getFlag(COSName.FF, PDTextField.FLAG_DO_NOT_SCROLL);
  }
  ...
  public void setDoNotScroll(final boolean doNotScroll) {
    getCOSObject().setFlag(COSName.FF, PDTextField.FLAG_DO_NOT_SCROLL, doNotScroll);
  }
  ...
  public boolean isComb() {
    return getCOSObject().getFlag(COSName.FF, PDTextField.FLAG_COMB);
  }
  ...
  public void setComb(final boolean comb) {
    getCOSObject().setFlag(COSName.FF, PDTextField.FLAG_COMB, comb);
  }
  ...
  public boolean isRichText() {
    return getCOSObject().getFlag(COSName.FF, PDTextField.FLAG_RICH_TEXT);
  }
  ...
  public void setRichText(final boolean richText) {
    getCOSObject().setFlag(COSName.FF, PDTextField.FLAG_RICH_TEXT, richText);
  }

  /**
   * Returns the maximum number of characters of the text field.
   *
   * @return the maximum number of characters, returns -1 if the value isn't
   *         present
   */
  ...
  /**
   * Set the plain text value of this field, and try to update the visual
   * appearance.
   *
