...
/**
 * That class builds visible signature template which will be added in our PDF
 * document.
 *
...
public interface PDFTemplateBuilder {
  ...
  /**
   * Creates the signature with the given name and assign it to the signature
   * field parameter and assign the page parameter to the widget.
   *
   * @param pdSignatureField
   * @param page
   * @param signerName       the name of the person or authority signing the
   *                         document. According to the PDF specification, this
   *                         value should be used only when it is not possible to
   ...
   * @throws IOException
   */
  void createImageForm(PDResources imageFormResources, PDResources innerFormResource, PDStream imageFormStream,
      PDRectangle bbox, AffineTransform affineTransform, PDImageXObject img) throws IOException;
   ...
   * @param procSet
   */
  void injectProcSetArray(PDFormXObject innerForm, PDPage page, PDResources innerFormResources,
   ...
   * @throws IOException
   */
  void injectAppearanceStreams(PDStream holderFormStream, PDStream innerFormStream, PDStream imageFormStream,
      COSName imageFormName, COSName imageName, COSName innerFormName, PDVisibleSignDesigner properties)
      throws IOException;
