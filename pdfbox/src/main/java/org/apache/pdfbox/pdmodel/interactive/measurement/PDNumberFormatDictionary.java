...
public class PDNumberFormatDictionary implements COSObjectable {
  ...
  /**
   * Constant for showing a fractional value as decimal to the precision specified
   * by the D entry.
   */
  public static final String FRACTIONAL_DISPLAY_DECIMAL = "D";
  /**
   * Constant for showing a fractional value as a fraction with denominator
   * specified by the D entry.
   */
  public static final String FRACTIONAL_DISPLAY_FRACTION = "F";
  /**
   * Constant for showing a fractional value without fractional part; round to the
   * nearest whole unit.
   */
  public static final String FRACTIONAL_DISPLAY_ROUND = "R";
  /**
   * Constant for showing a fractional value without fractional part; truncate to
   * achieve whole units.
   */
  ...
  public PDNumberFormatDictionary() {
    numberFormatDictionary = new COSDictionary();
    numberFormatDictionary.setName(COSName.TYPE, PDNumberFormatDictionary.TYPE);
  }
  ...
  public PDNumberFormatDictionary(final COSDictionary dictionary) {
    numberFormatDictionary = dictionary;
  }
  ...
  public COSDictionary getCOSObject() {
    return numberFormatDictionary;
  }

  /**
   * This will return the type of the number format dictionary. It must be
   * "NumberFormat"
   *
   * @return the type
   */
  public String getType() {
    return PDNumberFormatDictionary.TYPE;
  }
  ...
  public void setUnits(final String units) {
    getCOSObject().setString("U", units);
  }
  ...
  public String getFractionalDisplay() {
    return getCOSObject().getString("F", PDNumberFormatDictionary.FRACTIONAL_DISPLAY_DECIMAL);
  }

  /**
   * This will set the value for the manner to display a fractional value. Allowed
   * values are "D", "F", "R" and "T"
   *
  ...
  public void setFractionalDisplay(final String fractionalDisplay) {
    if (fractionalDisplay == null || PDNumberFormatDictionary.FRACTIONAL_DISPLAY_DECIMAL.equals(fractionalDisplay)
        || PDNumberFormatDictionary.FRACTIONAL_DISPLAY_FRACTION.equals(fractionalDisplay)
        || PDNumberFormatDictionary.FRACTIONAL_DISPLAY_ROUND.equals(fractionalDisplay)
        || PDNumberFormatDictionary.FRACTIONAL_DISPLAY_TRUNCATE.equals(fractionalDisplay)) {
  ...
  /**
   * This will return the value indication if the denominator of the fractional
   * value is reduced/truncated .
   *
   * @return fd
   */
  public boolean isFD() {
  ...
  /**
   * This will set the value indication if the denominator of the fractional value
   * is reduced/truncated . The denominator may not be reduced/truncated if true
   *
   * @param fd fd
   */
  ...
  /**
   * This will return the text to be used between orders of thousands in display
   * of numerical values.
   *
   * @return thousands separator
   */
  public String getThousandsSeparator() {
    return getCOSObject().getString("RT", ",");
  }

  /**
   * This will set the text to be used between orders of thousands in display of
   * numerical values.
   *
   * @param thousandsSeparator thousands separator
   */
  public void setThousandsSeparator(final String thousandsSeparator) {
    getCOSObject().setString("RT", thousandsSeparator);
  }

  /**
   * This will return the text to be used as the decimal point in displaying
   * numerical values.
   *
  ...
  /**
   * This will set the text to be used as the decimal point in displaying
   * numerical values.
   *
  ...
  /**
   * This will return the text to be concatenated to the left of the label
   * specified by U.
   *
   * @return label prefix
   */
  ...
  /**
   * This will set the text to be concatenated to the left of the label specified
   * by U.
   *
  ...
  /**
   * This will return a value indicating the ordering of the label specified by U
   * to the calculated unit value.
   *
   * @return label position
   */
  public String getLabelPositionToValue() {
    return getCOSObject().getString("O", PDNumberFormatDictionary.LABEL_SUFFIX_TO_VALUE);
  }

  /**
   * This will set the value indicating the ordering of the label specified by U
   * to the calculated unit value. Possible values are "S" and "P"
   *
   * @param labelPositionToValue label position
   */
  public void setLabelPositionToValue(final String labelPositionToValue) {
    if (labelPositionToValue == null || PDNumberFormatDictionary.LABEL_PREFIX_TO_VALUE.equals(labelPositionToValue)
        || PDNumberFormatDictionary.LABEL_SUFFIX_TO_VALUE.equals(labelPositionToValue)) {
      getCOSObject().setString("O", labelPositionToValue);
    } else
