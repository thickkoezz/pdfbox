...
/**
 * Represents a page transition as defined in paragraph 12.4.4.1 of PDF
 * 32000-1:2008
 *
...
public final class PDTransition extends PDDictionaryWrapper {
  ...
  /**
   * @return The dimension in which the specified transition effect shall occur or
   *         the default {@link PDTransitionDimension#H} if no dimension is found.
  ...
  /**
   * Sets the dimension in which the specified transition effect shall occur. Only
   * for {@link PDTransitionStyle#Split} and {@link PDTransitionStyle#Blinds}.
   */
  ...
  /**
   * @return The direction of motion for the specified transition effect or the
   *         default {@link PDTransitionMotion#I} if no motion is found.
  ...
  /**
   * Sets the direction of motion for the specified transition effect. Only for
   * {@link PDTransitionStyle#Split}, {@link PDTransitionStyle#Blinds} and
  ...
  /**
   * @return the direction in which the specified transition effect shall moves.
   *         It can be either a {@link COSInteger} or {@link COSName#NONE}.
   *         Default to {@link COSInteger#ZERO}
  ...
  /**
   * Sets the direction in which the specified transition effect shall moves. Only
   * for {@link PDTransitionStyle#Wipe}, {@link PDTransitionStyle#Glitter},
   * {@link PDTransitionStyle#Fly}, {@link PDTransitionStyle#Cover},
  ...
  /**
   * @return The duration in seconds of the transition effect or the default 1 if
  ...
  /**
   * @return The starting or ending scale at which the changes shall be drawn or
   *         the default 1 if no scale is found. Only for
   *         {@link PDTransitionStyle#Fly}.
   */
  ...
  /**
   * @param scale The starting or ending scale at which the changes shall be
   *              drawn. Only for {@link PDTransitionStyle#Fly}.
   */
  ...
  /**
   * @return true if the area that shall be flown in is rectangular and opaque.
   *         Default is false. Only for {@link PDTransitionStyle#Fly}.
   */
  ...
  /**
   * @param opaque If true, the area that shall be flown in is rectangular and
   *               opaque. Only for {@link PDTransitionStyle#Fly}.
   */
