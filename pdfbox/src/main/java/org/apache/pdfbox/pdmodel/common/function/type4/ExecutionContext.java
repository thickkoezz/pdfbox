...
/**
 * Makes up the execution context, holding the available operators and the
 * execution stack.
 *
 */
public class ExecutionContext {
  ...
  /**
   * Pops a number from the stack and returns it as a real value. If the value is
   * not of a numeric type, a ClassCastException is thrown.
   *
