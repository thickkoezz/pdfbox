...
public class PDPageFitWidthDestination extends PDPageDestination {
  ...
  public PDPageFitWidthDestination() {
    super();
    array.growToSize(3);
    array.setName(1, PDPageFitWidthDestination.TYPE);
  ...
  public boolean fitBoundingBox() {
    return PDPageFitWidthDestination.TYPE_BOUNDED.equals(array.getName(1));
  }
  ...
  public void setFitBoundingBox(final boolean fitBoundingBox) {
    array.growToSize(2);
    if (fitBoundingBox) {
      array.setName(1, PDPageFitWidthDestination.TYPE_BOUNDED);
    } else {
      array.setName(1, PDPageFitWidthDestination.TYPE);
    }
  }
