...
public class PDRectangle implements COSObjectable {
  ...
  private static final float POINTS_PER_MM = 1 / (10 * 2.54f) * PDRectangle.POINTS_PER_INCH;

  /** A rectangle the size of U.S. Letter, 8.5" x 11". */
  public static final PDRectangle LETTER = new PDRectangle(8.5f * PDRectangle.POINTS_PER_INCH,
      11f * PDRectangle.POINTS_PER_INCH);
  /** A rectangle the size of U.S. Legal, 8.5" x 14". */
  public static final PDRectangle LEGAL = new PDRectangle(8.5f * PDRectangle.POINTS_PER_INCH,
      14f * PDRectangle.POINTS_PER_INCH);
  /** A rectangle the size of A0 Paper. */
  public static final PDRectangle A0 = new PDRectangle(841 * PDRectangle.POINTS_PER_MM,
      1189 * PDRectangle.POINTS_PER_MM);

  /** A rectangle the size of A1 Paper. */
  public static final PDRectangle A1 = new PDRectangle(594 * PDRectangle.POINTS_PER_MM,
      841 * PDRectangle.POINTS_PER_MM);

  /** A rectangle the size of A2 Paper. */
  public static final PDRectangle A2 = new PDRectangle(420 * PDRectangle.POINTS_PER_MM,
      594 * PDRectangle.POINTS_PER_MM);

  /** A rectangle the size of A3 Paper. */
  public static final PDRectangle A3 = new PDRectangle(297 * PDRectangle.POINTS_PER_MM,
      420 * PDRectangle.POINTS_PER_MM);

  /** A rectangle the size of A4 Paper. */
  public static final PDRectangle A4 = new PDRectangle(210 * PDRectangle.POINTS_PER_MM,
      297 * PDRectangle.POINTS_PER_MM);

  /** A rectangle the size of A5 Paper. */
  public static final PDRectangle A5 = new PDRectangle(148 * PDRectangle.POINTS_PER_MM,
      210 * PDRectangle.POINTS_PER_MM);

  /** A rectangle the size of A6 Paper. */
  public static final PDRectangle A6 = new PDRectangle(105 * PDRectangle.POINTS_PER_MM,
      148 * PDRectangle.POINTS_PER_MM);
   ...
   * Constructor.
   *
   * @param array An array of numbers as specified in the PDF Reference for a
   *              rectangle type.
   */
  ...
  /**
   * This will get the width of this rectangle as calculated by upperRightX -
   * lowerLeftX.
   *
  ...
  /**
   * This will get the height of this rectangle as calculated by upperRightY -
   * lowerLeftY.
   *
  ...
  /**
   * Returns a path which represents this rectangle having been transformed by the
   * given matrix. Note that the resulting path need not be rectangular.
   */
  ...
  /**
   * Returns a general path equivalent to this rectangle. This method avoids the
   * problems caused by Rectangle2D not working well with -ve rectangles.
   */
