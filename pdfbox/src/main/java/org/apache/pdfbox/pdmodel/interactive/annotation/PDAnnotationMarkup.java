...
public class PDAnnotationMarkup extends PDAnnotation {
  ...
  /**
   * Retrieve the string used as the title of the popup window shown when open and
  ...
  /**
   * This will set the annotation to which this one is "In Reply To" the actual
   * relationship is specified by the RT entry.
   *
  ...
  /**
   * This will retrieve the Reply Type (relationship) with the annotation in the
   * IRT entry See the RT_* constants for the available values.
   *
   * @return the relationship.
   */
  public String getReplyType() {
    return getCOSObject().getNameAsString("RT", PDAnnotationMarkup.RT_REPLY);
  }

  /**
   * This will set the Reply Type (relationship) with the annotation in the IRT
   * entry See the RT_* constants for the available values.
   *
   ...
   * specific to the actual annotation See the IT_* constants for the annotation
   * classes.
   *
   * @return the intent
   */
  ...
  public PDExternalDataDictionary getExternalData() {
    final COSBase exData = getCOSObject().getDictionaryObject("ExData");
