...
public class FDFField implements COSObjectable {
   ...
   * Where the fully qualified field name is a concatenation of the parent's fully
   * qualified field name and "." as a separator. For example<br>
   * Address.State<br>
   * Address.City<br>
   *
  ...
  /**
   * This will get the field flags that are associated with this field. The Ff
   * entry in the FDF field dictionary.
   *
  ...
  /**
   * This will get the SetFf entry of the cos dictionary. If it it not present
  ...
  /**
   * This will get the field flags that are associated with this field. The SetFf
   * entry in the FDF field dictionary.
   *
  ...
  /**
   * This will get the ClrFf entry of the cos dictionary. If it it not present
   * then this method will return null.
   *
   * @return The field flags.
   */
  ...
  /**
   * This will get the field flags that are associated with this field. The ClrFf
   * entry in the FDF field dictionary.
   *
  ...
  /**
   * This will get the widget field flags that are associated with this field. The
   * F entry in the FDF field dictionary.
   *
  ...
  /**
   * This will get the field flags that are associated with this field. The F
   * entry in the FDF field dictionary.
   *
   * @param f The new value for the field flags.
   */
  ...
  /**
   * This will get the widget field flags that are associated with this field. The
   * SetF entry in the FDF field dictionary.
   *
  ...
  /**
   * This will get the field flags that are associated with this field. The ClrF
   * entry in the FDF field dictionary.
   *
  ...
  /**
   * This will get the appearance dictionary that specifies the appearance of a
   * pushbutton field.
   *
  ...
  /**
   * This will return a list of options for a choice field. The value in the list
   * will be 1 of 2 types. java.lang.String or FDFOptionElement.
   *
  ...
  /**
   * This will get a list of additional actions that will get executed based on
   * events.
   *
