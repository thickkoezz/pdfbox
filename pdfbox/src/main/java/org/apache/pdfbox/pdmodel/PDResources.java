...
public final class PDResources implements COSObjectable {
  ...
  public PDFont getFont(final COSName name) throws IOException {
    ...
    PDFont font = null;
    final COSDictionary dict = (COSDictionary) get(COSName.FONT, name);
    if (dict != null) {
  ...
  /**
   * Returns the color space resource with the given name, or null if none exists.
   * This method is for PDFBox internal use only, others should use
   * {@link #getColorSpace(COSName)}.
   *
   * @param name       Name of the color space resource.
  ...
  /**
   * Returns the extended graphics state resource with the given name, or null if
   * none exists.
   *
  ...
  public PDExtendedGraphicsState getExtGState(final COSName name) {
    ...
    final COSDictionary dict = (COSDictionary) get(COSName.EXT_G_STATE, name);
    if (dict != null) {
  ...
  public PDShading getShading(final COSName name) throws IOException {
    ...
    final COSDictionary dict = (COSDictionary) get(COSName.SHADING, name);
    if (dict != null) {
  ...
  public PDAbstractPattern getPattern(final COSName name) throws IOException {
    ...
    final COSDictionary dict = (COSDictionary) get(COSName.PATTERN, name);
    if (dict != null) {
  ...
  /**
   * Returns the property list resource with the given name, or null if none
   * exists.
   *
  ...
  public PDPropertyList getProperties(final COSName name) {
    ...
    final COSDictionary dict = (COSDictionary) get(COSName.PROPERTIES, name);
    if (dict != null) {
  ...
  /**
   * Returns the resource with the given name and kind as an indirect object, or
   * null.
   */
  ...
  /**
   * Adds the given font to the resources of the current page and returns the name
   * for the new resources. Returns the existing resource name if the given item
   * already exists.
   *
  ...
  /**
   * Adds the given color space to the resources of the current page and returns
   * the name for the new resources. Returns the existing resource name if the
  ...
  /**
   * Adds the given extended graphics state to the resources of the current page
   * and returns the name for the new resources. Returns the existing resource
   * name if the given item already exists.
   *
  ...
  /**
   * Adds the given shading to the resources of the current page and returns the
   * name for the new resources. Returns the existing resource name if the given
   * item already exists.
   *
  ...
  /**
   * Adds the given pattern to the resources of the current page and returns the
   * name for the new resources. Returns the existing resource name if the given
   * item already exists.
   *
  ...
  /**
   * Adds the given property list to the resources of the current page and returns
   * the name for the new resources. Returns the existing resource name if the
   * given item already exists.
   *
  ...
  /**
   * Adds the given image to the resources of the current page and returns the
   * name for the new resources. Returns the existing resource name if the given
   * item already exists.
   *
  ...
  /**
   * Adds the given form to the resources of the current page and returns the name
   * for the new resources. Returns the existing resource name if the given item
   * already exists.
   *
  ...
  /**
   * Adds the given XObject to the resources of the current page and returns the
   * name for the new resources. Returns the existing resource name if the given
   * item already exists.
   *
  ...
  /**
   * Returns the resource cache associated with the Resources, or null if there is
   * none.
   */
