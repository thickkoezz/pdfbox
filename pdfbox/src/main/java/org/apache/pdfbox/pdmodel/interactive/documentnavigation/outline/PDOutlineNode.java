...
public abstract class PDOutlineNode extends PDDictionaryWrapper {
   ...
   * @throws IllegalArgumentException if the given node is part of a list (i.e. if
   *                                  it has a previous or a next sibling)
   */
  ...
  /**
   * Appends the child to the linked list of children. This method only adjust
   * pointers but doesn't take care of the Count key in the parent hierarchy.
   *
   * @param newChild
   */
  ...
  /**
   * Prepends the child to the linked list of children. This method only adjust
   * pointers but doesn't take care of the Count key in the parent hierarchy.
   *
   * @param newChild
   */
  ...
  /**
   * Get the number of open nodes or a negative number if this node is closed. See
   * PDF Reference 32000-1:2008 table 152 and 153 for more details. This value is
   * updated as you append children and siblings.
   *
  ...
  /**
   * Set the open count. This number is automatically managed for you when you add
  ...
  /**
   * This will set this node to be open when it is shown in the viewer. By
   * default, when a new node is created it will be closed. This will do nothing
  ...
  /**
   * The count parameter needs to be updated when you add, remove, open or close
   * outline items.
   *
