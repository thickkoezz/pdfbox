...
public class FDFAnnotationText extends FDFAnnotation {
  ...
  public FDFAnnotationText() {
    super();
    annot.setName(COSName.SUBTYPE, FDFAnnotationText.SUBTYPE);
  }
  ...
  /**
   * This will set the icon (and hence appearance, AP taking precedence) For this
   * annotation. See the PDAnnotationText.NAME_XXX constants for valid values.
   *
  ...
  /**
   * This will retrieve the icon (and hence appearance, AP taking precedence) For
   * this annotation. The default is NOTE.
   *
   * @return The name of this annotation, see the PDAnnotationText.NAME_XXX
   *         constants.
   */
