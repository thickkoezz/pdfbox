...
public final class PDTransparencyGroupAttributes implements COSObjectable {
  ...
  /**
   * Returns true if this group is isolated. Isolated groups begin with the fully
   * transparent image, non-isolated begin with the current backdrop.
   */
  ...
  /**
   * Returns true if this group is a knockout. A knockout group blends with
   * original backdrop, a non-knockout group blends with the current backdrop.
   */
