...
public abstract class PDAnnotation implements COSObjectable {
   ...
   * in default user space units. This is usually required and should not return
   * null on valid PDF documents. But where this is a parent form field with
  ...
  public PDRectangle getRectangle() {
    ...
    if (rectArray != null) {
      if (rectArray.size() == 4 && rectArray.getObject(0) instanceof COSNumber
        ...
        PDAnnotation.LOG.warn(rectArray + " is not a rectangle array, returning null");
      }
    }
    return rectangle;
  }
  ...
  /**
   * Returns the annotations appearance state, which selects the applicable
  ...
  /**
   * Returns the appearance stream for this annotation, if any. The annotation
   * state is taken into account, if present.
   */
  ...
  public boolean isInvisible() {
    return getCOSObject().getFlag(COSName.F, PDAnnotation.FLAG_INVISIBLE);
  }
  ...
  public void setInvisible(final boolean invisible) {
    getCOSObject().setFlag(COSName.F, PDAnnotation.FLAG_INVISIBLE, invisible);
  }
  ...
  public boolean isHidden() {
    return getCOSObject().getFlag(COSName.F, PDAnnotation.FLAG_HIDDEN);
  }
  ...
  public void setHidden(final boolean hidden) {
    getCOSObject().setFlag(COSName.F, PDAnnotation.FLAG_HIDDEN, hidden);
  }
  ...
  public boolean isPrinted() {
    return getCOSObject().getFlag(COSName.F, PDAnnotation.FLAG_PRINTED);
  }
  ...
  public void setPrinted(final boolean printed) {
    getCOSObject().setFlag(COSName.F, PDAnnotation.FLAG_PRINTED, printed);
  }
  ...
  public boolean isNoZoom() {
    return getCOSObject().getFlag(COSName.F, PDAnnotation.FLAG_NO_ZOOM);
  }
  ...
  public void setNoZoom(final boolean noZoom) {
    getCOSObject().setFlag(COSName.F, PDAnnotation.FLAG_NO_ZOOM, noZoom);
  }
  ...
  public boolean isNoRotate() {
    return getCOSObject().getFlag(COSName.F, PDAnnotation.FLAG_NO_ROTATE);
  }
  ...
  public void setNoRotate(final boolean noRotate) {
    getCOSObject().setFlag(COSName.F, PDAnnotation.FLAG_NO_ROTATE, noRotate);
  }
  ...
  public boolean isNoView() {
    return getCOSObject().getFlag(COSName.F, PDAnnotation.FLAG_NO_VIEW);
  }
  ...
  public void setNoView(final boolean noView) {
    getCOSObject().setFlag(COSName.F, PDAnnotation.FLAG_NO_VIEW, noView);
  }
  ...
  public boolean isReadOnly() {
    return getCOSObject().getFlag(COSName.F, PDAnnotation.FLAG_READ_ONLY);
  }
  ...
  public void setReadOnly(final boolean readOnly) {
    getCOSObject().setFlag(COSName.F, PDAnnotation.FLAG_READ_ONLY, readOnly);
  }
  ...
  public boolean isLocked() {
    return getCOSObject().getFlag(COSName.F, PDAnnotation.FLAG_LOCKED);
  }
  ...
  public void setLocked(final boolean locked) {
    getCOSObject().setFlag(COSName.F, PDAnnotation.FLAG_LOCKED, locked);
  }
  ...
  public boolean isToggleNoView() {
    return getCOSObject().getFlag(COSName.F, PDAnnotation.FLAG_TOGGLE_NO_VIEW);
  }
  ...
  public void setToggleNoView(final boolean toggleNoView) {
    getCOSObject().setFlag(COSName.F, PDAnnotation.FLAG_TOGGLE_NO_VIEW, toggleNoView);
  }
   ...
   *
   * @return the modified date/time (often in date format, but can be an arbitary
   *         string).
   */
   ...
   *
   * @param m the date and time the annotation was created. Date values used in a
   *          PDF shall conform to a standard date format, which closely follows
   *          that of the international standard ASN.1 (Abstract Syntax Notation
   *          One), defined in ISO/IEC 8824. A date shall be a text string of the
   *          form (D:YYYYMMDDHHmmSSOHH'mm). Alternatively, use
  ...
  /**
   * This will get the name, a string intended to uniquely identify each
   * annotation within a page. Not to be confused with some annotations Name entry
  ...
  /**
   * This will set the name, a string intended to uniquely identify each
   * annotation within a page. Not to be confused with some annotations Name entry
   * which impact the default image drawn for them.
   *
   ...
   *
   * @return the integer key of the annotation's entry in the structural parent
   *         tree or -1 if there isn't any.
   */
  ...
  /**
   * This will get the optional content group or optional content membership
   * dictionary for the annotation.
   *
   * @return The optional content group or optional content membership dictionary
  ...
  /**
   * Sets the optional content group or optional content membership dictionary for
   * the annotation.
   *
   * @param oc The optional content group or optional content membership
   *           dictionary.
   */
  ...
  /**
   * This will retrieve the border array. If none is available then it will return
   * the default, which is [0 0 1]. The array consists of at least three numbers
   * defining the horizontal corner radius, vertical corner radius, and border
   * width. The array may have a fourth element, an optional dash array defining a
   * pattern of dashes and gaps that shall be used in drawing the border. If the
   * array has less than three elements, it will be filled with 0.
   *
  ...
  /**
   * This will set the color used in drawing various elements. As of PDF 1.6 these
   * are : Background of icon when closed Title bar of popup window Border of a
   * link annotation
   *
  ...
  /**
   * This will retrieve the color used in drawing various elements. As of PDF 1.6
   * these are :
   * <ul>
  ...
  /**
   * Create the appearance entry for this annotation. Not having it may prevent
