...
class PDType1FontEmbedder {
  ...
  PDType1FontEmbedder(final PDDocument doc, final COSDictionary dict, final InputStream pfbStream,
    ...
    final PDFontDescriptor fd = PDType1FontEmbedder.buildFontDescriptor(type1);
  ...
  static PDFontDescriptor buildFontDescriptor(final Type1Font type1) {
    final boolean isSymbolic = type1.getEncoding() instanceof org.apache.fontbox.encoding.BuiltInEncoding;
