...
/**
 * This class wraps a pattern dictionary. Patterns can be found in resource
 * dictionaries.
 */
public abstract class PDAbstractPattern implements COSObjectable {
   ...
   */
  public static PDAbstractPattern create(final COSDictionary dictionary) throws IOException {
