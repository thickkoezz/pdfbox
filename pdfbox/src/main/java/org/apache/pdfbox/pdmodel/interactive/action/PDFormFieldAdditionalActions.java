...
/**
 * This class represents a form field's dictionary of actions that occur due to
 * events.
 *
...
public class PDFormFieldAdditionalActions implements COSObjectable {
  ...
  /**
   * This will get a JavaScript action to be performed when the user types a
   * keystroke into a text field or combo box or modifies the selection in a
   * scrollable list box. This allows the keystroke to be checked for validity and
  ...
  /**
   * This will set a JavaScript action to be performed when the user types a
   * keystroke into a text field or combo box or modifies the selection in a
   * scrollable list box. This allows the keystroke to be checked for validity and
   * rejected or modified.
   *
  ...
  /**
   * This will get a JavaScript action to be performed before the field is
  ...
  /**
   * This will set a JavaScript action to be performed before the field is
   * formatted to display its current value. This allows the field's value to be
   * modified before formatting.
   *
  ...
  /**
   * This will get a JavaScript action to be performed when the field's value is
  ...
  /**
   * This will set a JavaScript action to be performed when the field's value is
   * changed. This allows the new value to be checked for validity. The name V
   * stands for "validate".
   *
  ...
  /**
   * This will get a JavaScript action to be performed in order to recalculate the
   * value of this field when that of another field changes. The order in which
   * the document's fields are recalculated is defined by the CO entry in the
   * interactive form dictionary. The name C stands for "calculate".
   *
  ...
  /**
   * This will set a JavaScript action to be performed in order to recalculate the
   * value of this field when that of another field changes. The order in which
   * the document's fields are recalculated is defined by the CO entry in the
   * interactive form dictionary. The name C stands for "calculate".
   *
