...
/**
 * Implementation of {@link PDFTemplateBuilder}. This builds the signature PDF
 * but doesn't keep the elements, these are kept in its PDF template structure.
 *
...
public class PDVisibleSigBuilder implements PDFTemplateBuilder {
  ...
  public PDVisibleSigBuilder() {
    ...
    PDVisibleSigBuilder.LOG.info("PDF Structure has been created");
  }

  @Override
  public void createPage(final PDVisibleSignDesigner properties) {
    final PDPage page = new PDPage(new PDRectangle(properties.getPageWidth(), properties.getPageHeight()));
    pdfStructure.setPage(page);
    PDVisibleSigBuilder.LOG.info("PDF page has been created");
  }

  /**
   * Creates a PDDocument and adds the page parameter to it and keeps this as a
   * template in the PDF template Structure.
   *
   * @param page
   * @throws IOException
   */
  ...
  public void createAcroForm(final PDDocument template) {
    ...
    PDVisibleSigBuilder.LOG.info("AcroForm has been created");
  }
  ...
  public void createSignatureField(final PDAcroForm acroForm) throws IOException {
    ...
    PDVisibleSigBuilder.LOG.info("Signature field has been created");
  }
  ...
  public void createSignature(final PDSignatureField pdSignatureField, final PDPage page, final String signerName)
    ...
    PDVisibleSigBuilder.LOG.info("PDSignature has been created");
  }
  ...
  public void createAcroFormDictionary(final PDAcroForm acroForm, final PDSignatureField signatureField)
    ...
    PDVisibleSigBuilder.LOG.info("AcroForm dictionary has been created");
  }

  @Override
  public void createSignatureRectangle(final PDSignatureField signatureField, final PDVisibleSignDesigner properties)
      throws IOException {
  ...
  public void createProcSetArray() {
    ...
    PDVisibleSigBuilder.LOG.info("ProcSet array has been created");
  }
  ...
  public void createSignatureImage(final PDDocument template, final BufferedImage image) throws IOException {
    ...
    PDVisibleSigBuilder.LOG.info("Visible Signature Image has been created");
  }
  ...
  public void createFormatterRectangle(final int[] params) {
    ...
    PDVisibleSigBuilder.LOG.info("Formatter rectangle has been created");
  }
  ...
  public void createHolderFormStream(final PDDocument template) {
    ...
    PDVisibleSigBuilder.LOG.info("Holder form stream has been created");
  }
  ...
  public void createHolderFormResources() {
    ...
    PDVisibleSigBuilder.LOG.info("Holder form resources have been created");
  ...
  public void createHolderForm(final PDResources holderFormResources, final PDStream holderFormStream,
    ...
    PDVisibleSigBuilder.LOG.info("Holder form has been created");

  }

  @Override
  public void createAppearanceDictionary(final PDFormXObject holderForml, final PDSignatureField signatureField)
      throws IOException {
    ...
    PDVisibleSigBuilder.LOG.info("PDF appearance dictionary has been created");
  }
  ...
  public void createInnerFormStream(final PDDocument template) {
    ...
    PDVisibleSigBuilder.LOG
        .info("Stream of another form (inner form - it will be inside holder form) " + "has been created");
  }
  ...
  public void createInnerFormResource() {
    ...
    PDVisibleSigBuilder.LOG
        .info("Resources of another form (inner form - it will be inside holder form)" + "have been created");
  }
  ...
  public void createInnerForm(final PDResources innerFormResources, final PDStream innerFormStream,
    ...
    PDVisibleSigBuilder.LOG.info("Another form (inner form - it will be inside holder form) has been created");
  }

  @Override
  public void insertInnerFormToHolderResources(final PDFormXObject innerForm, final PDResources holderFormResources) {
    holderFormResources.put(COSName.FRM, innerForm);
    pdfStructure.setInnerFormName(COSName.FRM);
    PDVisibleSigBuilder.LOG.info("Now inserted inner form inside holder form");
  }
  ...
  public void createImageFormStream(final PDDocument template) {
    ...
    PDVisibleSigBuilder.LOG.info("Created image form stream");
  }
  ...
  public void createImageFormResources() {
    ...
    PDVisibleSigBuilder.LOG.info("Created image form resources");
  }

  @Override
  public void createImageForm(final PDResources imageFormResources, final PDResources innerFormResource,
      final PDStream imageFormStream, final PDRectangle bbox, final AffineTransform at, final PDImageXObject img)
      throws IOException {
    ...
    PDVisibleSigBuilder.LOG.info("Created image form");
  }
  ...
  public void createBackgroundLayerForm(final PDResources innerFormResource, final PDRectangle bbox)
    ...
    PDVisibleSigBuilder.LOG.info("Created background layer form");
  }

  @Override
  public void injectProcSetArray(final PDFormXObject innerForm, final PDPage page, final PDResources innerFormResources,
      final PDResources imageFormResources, final PDResources holderFormResources, final COSArray procSet) {
    ...
    PDVisibleSigBuilder.LOG.info("Inserted ProcSet to PDF");
  }

  @Override
  public void injectAppearanceStreams(final PDStream holderFormStream, final PDStream innerFormStream,
      final PDStream imageFormStream, final COSName imageFormName, final COSName imageName, final COSName innerFormName,
    ...
    final int width = (int) getStructure().getFormatterRectangle().getWidth();
    final int height = (int) getStructure().getFormatterRectangle().getHeight();
    ...
    final String innerFormContent = "q 1 0 0 1 0 0 cm /n0 Do Q q 1 0 0 1 0 0 cm /" + imageFormName.getName()
        + " Do Q\n";
    ...
    PDVisibleSigBuilder.LOG.info("Injected appearance stream to pdf");
  }
  ...
  public void createVisualSignature(final PDDocument template) {
    ...
    PDVisibleSigBuilder.LOG.info("Visible signature has been created");
  }

  @Override
  public void createWidgetDictionary(final PDSignatureField signatureField, final PDResources holderFormResources)
      throws IOException {
    ...
    PDVisibleSigBuilder.LOG.info("WidgetDictionary has been created");
  }
