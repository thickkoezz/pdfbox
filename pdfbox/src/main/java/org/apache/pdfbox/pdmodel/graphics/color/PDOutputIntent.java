...
/**
 * An Output Intent describes the colour reproduction characteristics of a
...
public final class PDOutputIntent implements COSObjectable {
  ...
  private PDStream configureOutputProfile(final PDDocument doc, final InputStream colorProfile) throws IOException {
