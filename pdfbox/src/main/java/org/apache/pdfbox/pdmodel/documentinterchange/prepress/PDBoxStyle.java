...
public class PDBoxStyle implements COSObjectable {
  ...
  /**
   * Get the RGB color to be used for the guidelines. This is guaranteed to not
   * return null. The default color is [0,0,0].
   *
  ...
  public PDColor getGuidelineColor() {
    ...
    final PDColor color = new PDColor(colorValues.toFloatArray(), PDDeviceRGB.INSTANCE);
    return color;
  }
  ...
  /**
   * Get the width of the of the guideline in default user space units. The
   * default is 1.
   *
  ...
  public String getGuidelineStyle() {
    return dictionary.getNameAsString(COSName.S, PDBoxStyle.GUIDELINE_STYLE_SOLID);
  }
