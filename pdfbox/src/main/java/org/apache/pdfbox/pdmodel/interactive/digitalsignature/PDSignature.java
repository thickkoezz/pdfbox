...
/**
 * This represents a digital signature that can be attached to a document. To
 * learn more about digital signatures, read <a href=
 * "https://www.adobe.com/devnet-docs/acrobatetk/tools/DigSig/Acrobat_DigitalSignatures_in_PDF.pdf">Digital
...
public class PDSignature implements COSObjectable {
  ...
  /**
   * Sets the name of the person or authority signing the document. According to
   * the PDF specification, this value should be used only when it is not possible
   * to extract the name from the signature.
   *
  ...
  /**
   * Sets the contact info provided by the signer to enable a recipient to contact
   * the signer to verify the signature, e.g. a phone number.
   *
  ...
  /**
   * Returns the name of the person or authority signing the document. According
   * to the PDF specification, this value should be used only when it is not
   * possible to extract the name from the signature.
   *
   * @return the name
   */
  ...
  /**
   * Returns the contact info provided by the signer to enable a recipient to
   * contact the signer to verify the signature, e.g. a phone number.
   *
  ...
  /**
   * Return the signed content of the document. This is not a PDF file, nor is it
   * the PDF file before signing, it is the byte sequence made of the input minus
   * the area where the signature bytes will be. See "The ByteRange and signature
   * value" in the document <a href=
   * "https://www.adobe.com/devnet-docs/acrobatetk/tools/DigSig/Acrobat_DigitalSignatures_in_PDF.pdf#page=5">Digital
  ...
  /**
   * PDF signature build dictionary. Provides informations about the signature
   * handler.
   *
  ...
  public PDPropBuild getPropBuild() {
    ...
    final COSDictionary propBuildDic = (COSDictionary) dictionary.getDictionaryObject(COSName.PROP_BUILD);
