...
public class PDAppearanceDictionary implements COSObjectable {
  ...
  /**
   * This will return a list of appearances. In the case where there is only one
   * appearance the map will contain one entry whose key is the string "default".
   *
  ...
  /**
   * This will set the normal appearance when there is only one appearance to be
   * shown.
   *
   ...
   * This will return a list of appearances. In the case where there is only one
   * appearance the map will contain one entry whose key is the string "default".
   * If there is no rollover appearance then the normal appearance will be
  ...
  /**
   * This will set the rollover appearance when there is rollover appearance to be
   * shown.
   *
   * @param ap The appearance stream to show.
   */
