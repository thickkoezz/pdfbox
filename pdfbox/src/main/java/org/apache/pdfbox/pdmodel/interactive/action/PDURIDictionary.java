...
public class PDURIDictionary implements COSObjectable {
  ...
  public PDURIDictionary() {
    uriDictionary = new COSDictionary();
  }
   ...
   * interpreted relative to this base address. If no base URI is specified, such
   * partial URIs will be interpreted relative to the location of the document
   * itself. The use of this entry is parallel to that of the body element
   * &lt;BASE&gt;, as described in the HTML 4.01 Specification.
   *
