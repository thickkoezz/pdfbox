...
/**
 * simple output stream with some minor features for generating "pretty" PDF
 * files.
 *
...
public class COSStandardOutputStream extends FilterOutputStream {
  ...
  public void writeCRLF() throws IOException {
    write(COSStandardOutputStream.CRLF);
  }
  ...
  public void writeEOL() throws IOException {
    if (!isOnNewLine()) {
      write(COSStandardOutputStream.EOL);
      setOnNewLine(true);
    }
  }
  ...
  public void writeLF() throws IOException {
    write(COSStandardOutputStream.LF);
  }
}
