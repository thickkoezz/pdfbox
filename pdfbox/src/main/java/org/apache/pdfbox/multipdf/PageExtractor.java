...
public class PageExtractor {
   ...
   * Both startPage and endPage are included in the extracted document. If the
   * endPage is greater than the number of pages in the source document, it will
   * go to the end of the document. If startPage is less than 1, it'll start with
   * page 1. If startPage is greater than endPage or greater than the number of
