...
public final class QuickSort {
  ...
  private static final Comparator<? extends Comparable> OBJCOMP = (object1, object2) -> object1.compareTo(object2);
  ...
  public static <T extends Comparable> void sort(final List<T> list) {
    QuickSort.sort(list, (Comparator<T>) QuickSort.OBJCOMP);
  }
  ...
  private static <T> int partition(final List<T> list, final Comparator<T> cmp, final int p, final int start,
      final int end) {
    int l = start;
    int h = end - 2;
