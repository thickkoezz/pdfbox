...
public class COSArray extends COSBase implements Iterable<COSBase>, COSUpdateInfo {
  ...
  /**
   * This will get an object from the array. This will dereference the object. If
   * the object is COSNull then null will be returned.
   *
  ...
  /**
   * This will get an object from the array. This will NOT dereference the COS
   * object.
   *
   * @param index The index into the array to get the object.
   *
  ...
  /**
   * Get the value of the array as an integer, return the default if it does not
   * exist.
   *
  ...
  /**
   * This will remove an element from the array. This method will also remove a
  ...
  /**
   * This will return the index of the entry or -1 if it is not found. This method
   * will also find references to indirect objects.
   *
   * @param object The object to search for.
   * @return The index of the object or -1.
   */
  ...
  /**
   * This will add null values until the size of the array is at least as large as
   * the parameter. If the array is already larger than the parameter then nothing
   * is done.
   *
  ...
  /**
   * This will add the object until the size of the array is at least as large as
   * the parameter. If the array is already larger than the parameter then nothing
   * is done.
   *
   * @param size   The desired size of the array.
   ...
   * {@inheritDoc}
   * <p>
   * Although the state is set, it has no effect on COSWriter behavior because
   * arrays are always written as direct object. If an array is to be part of an
   * incremental save, then the method should be called for its holding
   * dictionary.
   *
   * @param flag
   */
