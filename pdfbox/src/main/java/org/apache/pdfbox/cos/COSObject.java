...
public class COSObject extends COSBase implements COSUpdateInfo {
   ...
   */
  public final void setObject(final COSBase object) {
    baseObject = object;
  }
   ...
   */
  public void setObjectNumber(final long objectNum) {
   ...
   */
  public void setGenerationNumber(final int generationNumberValue) {
